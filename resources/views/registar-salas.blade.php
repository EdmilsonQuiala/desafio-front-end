            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="designacao" name="designacao" placeholder="Ex: Salas de Aula Teóricas">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label for="funcionais">Funcionais</label>
                        <input type="number" class="form-control" id="funcionais" name="funcionais" min="0" oninput="this.value = Math.abs(this.value)">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label for="NaoFuncionais">Não Funcionais</label>
                        <input type="number" class="form-control" id="NaoFuncionais" name="NaoFuncionais" min="0" oninput="this.value = Math.abs(this.value)">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label for="NumeroTotalShow">Número total</label>
                        <input type="number" class="form-control" id="NumeroTotalShow" name="NumeroTotalShow" disabled min="0" oninput="this.value = Math.abs(this.value)">
                        <input type="hidden" class="form-control" id="NumeroTotal" name="NumeroTotal" min="0" oninput="this.value = Math.abs(this.value)">
                    </div>
                </div>
